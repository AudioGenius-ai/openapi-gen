...
export interface GetProductsResponseProductsItemPricesItemType {
  id: string;
...
export const GetProductsResponseProductsItemPricesItemTypeSchema = z.object({
  id: z.string().uuid(),
...
export interface GetProductsResponseProductsItemType {
  id: string;
  name: string;
  description: string;
  type: string;
  ...
  createdAt: string;
  updatedAt: string;
  prices: GetProductsResponseProductsItemPricesItemType[];
}

export const GetProductsResponseProductsItemTypeSchema = z.object({
  id: z.string().uuid(),
  name: z.string(),
  ...
  createdAt: z.string(),
  updatedAt: z.string(),
  prices: z.array(GetProductsResponseProductsItemPricesItemTypeSchema),
});
...
export class ProductsApi extends ApiClient {
  getProducts(): Promise<Record<string, any>> {
    return this.get(
      `/products`,
      z.object({
        products: z.array(GetProductsResponseProductsItemTypeSchema),
      })
    );
  }
